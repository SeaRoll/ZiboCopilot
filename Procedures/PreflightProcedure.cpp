...
int PreflightProcedure::preflightProcedure(int stage)
{
	if (stage == 0) {	//YAW DAMPER
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[2])) < 1)
		...
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[14])) == 0) {
		...
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[15])) == 0)
			XPLMCommandOnce(XPLMFindCommand("laminar/B738/toggle_switch/electric_hydro_pumps1"));
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[16])) == 0)
			XPLMCommandOnce(XPLMFindCommand("laminar/B738/toggle_switch/electric_hydro_pumps2"));
		return 1;
	}
	else if (stage == 9) {
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[17])) == 0)
		...
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[18])) == 0)
			XPLMCommandOnce(XPLMFindCommand("laminar/B738/toggle_switch/bleed_air_1"));
		return 1;
	}
	else if (stage == 14) {
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[20])) == 0)
			XPLMCommandOnce(XPLMFindCommand("laminar/B738/toggle_switch/bleed_air_apu"));
		return 1;
	}
	else if (stage == 15) {
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[19])) == 0)
		...
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[21])) == 0)
		...
		if (XPLMGetDatai(XPLMFindDataRef(data_ref_list.dataRefList[22])) == 0)
